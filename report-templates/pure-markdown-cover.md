...
|------|------|
| **目标系统** | DVWA 系统 |
| **目标 URL** | http://dvwa.example.com |
| **测试时间** | 2026-04-23 10:00:00 |
| **测试人员** | 安小易 (安全测试数字员工) |
| **风险等级** | **危急** |
...
本次对 DVWA 系统进行渗透测试，共发现漏洞 18 个，其中高危漏洞 12 个；中危漏洞 2 个；低危漏洞 3 个；信息暴露 4 个。因此判定其安全风险为**危急**。
